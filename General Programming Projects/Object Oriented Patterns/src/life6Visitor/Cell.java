...
public class Cell {
	...
	public void accept(LifeVisitor v, ArrayList<LifeCommand> commands) { //passes accept down to the state level to avoid if statements
		state.accept(v, this, commands);
	}
}
