...
public class DeadState implements CellState{
	...
	@Override
	public void accept(LifeVisitor v, Cell c, ArrayList<LifeCommand> commands) { //calls visitdeadcell to remove need to check if a cell is alive
		v.visitDeadCell(c, commands);
