...
def remove_stopwords_and_punctuation(tweet_toks : list[str], 
    ...
    '''
    newtweet_toks = [token for token in tweet_toks
...
def stem_tweet(tweet_toks : list[str], stemmer : PorterStemmer) -> list[str]:
    ...
    '''
    stemmed_toks = [stemmer.stem(token) for token in tweet_toks ]
...
def process_tweet(tweet : str, 
    ...
    tweet = remove_stopwords_and_punctuation(tweet, stopwords, punctuation)
